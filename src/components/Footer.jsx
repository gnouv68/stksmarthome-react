                            ...
                            <ul>
                                <li className="fc-info-item">
                                    ...
                                    <div className="wrap-left-info">
                                        <h4 className="fc-name">Miễn phí vận chuyển</h4>
                                        <p className="fc-desc">Trong nội thành đà nẵng</p>
                                    </div>
                                ...
                                {/*    <div className="wrap-left-info">*/}
                                {/*        <h4 className="fc-name"></h4>*/}
                                {/*        <p className="fc-desc"></p>*/}
                                {/*    </div>*/}
                                ...
                                <li className="fc-info-item">
                                    ...
                                    <div className="wrap-left-info">
                                        <h4 className="fc-name">Thanh Toán</h4>
                                        <p className="fc-desc">Thanh toán sau khi hoàn thành</p>
                                    </div>
                                ...
                                <li className="fc-info-item">
                                    ...
                                    <div className="wrap-left-info">
                                        <h4 className="fc-name">Hỗ trợ</h4>
                                        <p className="fc-desc">Chúng tôi luôn hỗ trợ 24/7</p>
                                    </div>
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                                    <div className="wrap-footer-item">
                                        <h3 className="item-header">Chi tiết liên hệ</h3>
                                        <div className="item-content">
                                            <div className="wrap-contact-detail">
                                                <ul>
                                                    <li>
                                                        <i className="fa fa-map-marker" aria-hidden="true"></i>
                                                        <p className="contact-txt">91 Lê Ấm, Phường Hoà Xuân, Quận Cẩm Lệ, Thành phố Đà Nẵng, Việt Nam</p>
                                                    </li>
                                                    <li>
                                                        <i className="fa fa-phone" aria-hidden="true"></i>
                                                        <p className="contact-txt">0898080179</p>
                                                    </li>
                                                    <li>
                                ...
                                <div className="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                                    ...
                                    <div className="wrap-footer-item">
                                        <h3 className="item-header">đường dây nóng</h3>
                                        <div className="item-content">
                                            <div className="wrap-hotline-footer">
                                                <span className="desc">Gọi cho chúng tôi miễn phí</span>
                                                <b className="phone-number">0898080179</b>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div className="coppy-right-box">
                        <div className="container">
                            <div className="coppy-right-item item-left">
                                <p className="coppy-right-text">Copyright © 2023 STK SmartHome. All rights reserved</p>
                            </div>
